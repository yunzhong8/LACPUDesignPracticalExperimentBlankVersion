...
/****************************************output code(输出解码)***************************************/
    assign to_wb_obus    = {crmd_reg[`CrmdPlvLocation],line2_csr_rdata_o,crmd_reg[`CrmdPlvLocation],line1_csr_rdata_o};     
    ...
    assign to_mmu_obus   = {crmd_reg[`CrmdPlvLocation],crmd_reg[`CrmdDaLocation],asid_reg,tlbehi_reg,{tlb_wf_ne_o,tlbidx_reg[30:0]},tlbelo0_reg,tlbelo1_reg, dmw1_reg, dmw0_reg};
...
//                           {32{   line2_    excep_entry_pc_o             }} &                |
 ...
 always@(posedge clk)begin
    if(rst_n == `RstEnable)begin   
        ...
        tlb_flush_entry_reg <= excep_pc_i;
    end
 end
